          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    // Ganti 'assets/pickup.png' dengan path asset kamu yang benar
                    Image.asset('assets/pickup.png', height: 40, errorBuilder: (context, error, stackTrace) => const Icon(Icons.local_shipping,)),
