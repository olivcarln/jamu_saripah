class Product {
  ...
  Product({
    ...
    required this.price, 
    required this.size, 
    required this.image, required this.description, required this.stock,
  });
}
